          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href={{route("categories.index")}}>
                <i class="fa fa-th"></i> <span>categories</span> <small class="label pull-right bg-green"></small>
              </a>
            </li>
            <li>
                <a href={{route("quizzes.index")}}>
                  <i class="fa fa-th"></i> <span>quizzes</span> <small class="label pull-right bg-green"></small>
                </a>
              </li>
              <li>
                <a href={{route("skills.index")}}>
                  <i class="fa fa-th"></i> <span>skills</span> <small class="label pull-right bg-green"></small>
                </a>
              </li>
              <li>
                <a href={{route("students.index")}}>
                  <i class="fa fa-th"></i> <span>students</span> <small class="label pull-right bg-green"></small>
                </a>
              </li>
